...
class DPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # NOTE: transformers 5.x 的 from_pretrained 在 meta device 上下文里跑 __init__,
        # 若不显式 device="cpu", 这些 torch.tensor/linspace 会落到 meta 设备,
        # 后续 self.sigmas.to("cpu") 报 "Cannot copy out of meta tensor". 强制建在 cpu。
